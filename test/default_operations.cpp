...
template<> struct default_eps< float > { static float def_eps( void ) { return 1.0e-5f; } };
...
BOOST_AUTO_TEST_CASE_TEMPLATE( scale_sum4_test , T , test_types  )
{
    ...
    Op op( T( 1.25 ) , T( 9.81 ) , T( 0.87 ) , T( -0.15 ) );
...
BOOST_AUTO_TEST_CASE_TEMPLATE( scale_sum5_test , T , test_types )
{
    ...
    Op op( T( 1.25 ) , T( 9.81 ) , T( 0.87 ) , T( -0.15 ) , T( -3.3 ) );
...
BOOST_AUTO_TEST_CASE_TEMPLATE( scale_sum6_test , T , test_types )
{
    ...
    Op op( T( 1.25 ) , T( 9.81 ) , T( 0.87 ) , T( -0.15 ) , T( -3.3 ) , T( 4.2 ) );
...
BOOST_AUTO_TEST_CASE_TEMPLATE( scale_sum7_test , T , test_types )
{
    ...
    Op op( T( 1.25 ) , T( 9.81 ) , T( 0.87 ) , T( -0.15 ) , T( -3.3 ) , T( 4.2 ) , T( -0.22 ) );
...
BOOST_AUTO_TEST_CASE_TEMPLATE( rel_error_test , T , test_types )
{
    ...
    Op op( T( 0.1 ) , T( 0.2 ) , T( 0.15 ) , T( 0.12 ) );
    op( f.res , -f.x1 , -f.x2 );
