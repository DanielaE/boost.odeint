...
namespace odeint {
    ...
    {
        static bool same_size( const diagnostic_type< N > & , const diagnostic_type< M > & )
        {
            return false;
        }
    };
    ...
    {
        static bool same_size( const diagnostic_type< N > & , const State1 & )
        {
            return false;
        }
    };
    ...
    {
        static bool same_size( const State1 & , const diagnostic_type< N > & )
        {
            return false;
        }
    };
    ...
    {
        static void resize( diagnostic_type< N > & , const StateIn & )
        {
