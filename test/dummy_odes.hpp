...
struct constant_system_functor_standard
{
    ...
    void operator()( const State & , Deriv &dxdt , const Time ) const
    {
        dxdt[0] = 1.0;
    }
};
...
{
    template< class State , class Deriv , class Time >
    void operator()( const State &x , Deriv &dxdt , const Time ) const
    {
...
template< class State , class Deriv , class Time >
void constant_system_standard( const State & , Deriv &dxdt , const Time )
{
    dxdt[0] = 1.0;
}

template< class State , class Deriv , class Time >
void constant_system_vector_space( const State & , Deriv &dxdt , const Time ) 
{
    dxdt = 1.0;
}

template< class State , class Deriv , class Time >
void constant_system_fusion( const State &x , Deriv &dxdt , const Time ) 
{
    boost::fusion::at_c< 0 >( dxdt ) = boost::fusion::at_c< 0 >( x ) / Time( 1.0 );
}
...
struct constant_mom_func
{
    ...
    void operator()( const StateIn & , StateOut &dp ) const
    {
        dp[0] = 1.0;
    }
};
...
{
    template< class T >
    void operator()( const T & , T &dp ) const
    {
        dp = 1.0;
    }
};
