...
public :
    ...
    template< class System  >
    controlled_step_result try_step( System , state_type & , time_type &t , time_type &dt )
    {
...
public :
    ...
    void calc_state( const time_type , state_type &x )
    {
        x = m_x;
    }
...
void lorenz( const state_type &x , state_type &dxdt , const value_type )
{
