...
struct ode
{
    ...
    void operator()( const CoorIn &q , const MomentumIn &p , AccelerationOut &a , Time ) const
    {
        a[0] = -q[0] - p[0];
        a[1] = -q[1] - p[1];
        ++ode_call_count;
...
struct ode_units
{
    void operator()( coor_vector const &q , velocity_vector const &p , accelartion_vector &a , time_type ) const
    {
